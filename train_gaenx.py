...
parser = argparse.ArgumentParser(description='Train a GAENX')
...
model_manager = ModelManager('gaenx', networks_dict, config)
    ...
    for epoch in range(model_manager.start_epoch, config['training']['n_epochs'] // 8):
        with model_manager.on_epoch(epoch):
            ...
            for batch in t:
                ...
                stream_images(images_dec, config_name + '/gaenx_pretrain', config['training']['out_dir'] + '/gaenx_pretrain')
    ...
    with model_manager.on_epoch(epoch):
        ...
        for batch in t:
            ...
            with model_manager.on_batch():
                ...
                stream_images(images_gen, config_name + '/gaenx', config['training']['out_dir'] + '/gaenx')
