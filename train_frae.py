            ...
            with model_manager.on_batch():
                ...
                with model_manager.on_step(['dis_encoder', 'discriminator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        lat_top_dec, _, _ = dis_encoder(images_redec, labels)
                ...
                # Copy class params to generator
                ...
                with model_manager.on_step(['encoder', 'decoder', 'generator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        lat_top_enc, _, _ = dis_encoder(images_redec, labels)
                        labs_enc = discriminator(lat_top_enc)

                        if g_reg_every > 0 and it % g_reg_every == 0:
                            reg_gen_enc, pl_mean_enc = compute_pl_reg(images_redec, lat_enc, pl_mean_enc)
