    ...
    with model_manager.on_epoch(epoch):
        ...
        for batch in t:
            ...
            with model_manager.on_batch():
                ...
                if not (config['training']['d_reg_every'] > 0 and it % d_reg_every == 0):
                ...
                with model_manager.on_step(['dis_encoder', 'discriminator']) as nets_to_train:
                    ...
                    for b in range(batch_mult):
                        ...
                        if config['training']['d_reg_every'] > 0 and it % d_reg_every == 0:
                        ...
                        if d_reg_every > 0 or (b % math.ceil(1 / d_reg_every)):
