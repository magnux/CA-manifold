                ...
                with model_manager.on_step(['encoder', 'decoder', 'generator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        if alt_reg and g_reg_every > 0 and it % g_reg_every == 0:
                            ...
                            reg_gen_enc = compute_grad_reg(1. / (1e-2 + F.mse_loss(lat_enc, lat_gen)), images_dec).mean()
                            ...
                            reg_gen_dec = compute_grad_reg(1. / (1e-2 + F.mse_loss(images_dec, images)), lat_enc).mean()
