...
g_reg_param_enc = model_manager.log_manager.get_last('regs', 'g_reg_param_enc', 1e3)
...
g_reg_param_dec = model_manager.log_manager.get_last('regs', 'g_reg_param_dec', 1e3)
