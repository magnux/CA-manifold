                ...
                with model_manager.on_step(['encoder', 'decoder', 'generator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        if alt_reg and g_reg_every > 0 and it % g_reg_every == 0:
                            ...
                            reg_gen_enc = compute_grad_reg(F.mse_loss(lat_enc, lat_gen), images_dec)
                            reg_gen_enc = (1 / batch_mult) * g_reg_every * (100. / (1. + reg_gen_enc))
                            ...
                            reg_gen_dec = compute_grad_reg(F.mse_loss(images_dec, images), lat_enc)
                            reg_gen_dec = (1 / batch_mult) * g_reg_every * (100. / (1. + reg_gen_dec))
