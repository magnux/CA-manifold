                ...
                with model_manager.on_batch():
                    ...
                    with model_manager.on_step(['encoder', 'decoder', 'generator']) as nets_to_train:
                        for _ in range(batch_split):
                            ...
                            images_dec, _, _ = decoder(lat_enc, seed=seed_idx[torch.ones_like(labels) * n_labels, model_manager.it % n_seed].tolist())
            ...
            with model_manager.on_batch():
                ...
                with model_manager.on_step(['dis_encoder', 'discriminator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        with torch.no_grad():
                            ...
                            images_redec, _, _ = decoder(lat_gen, seed_n=seed_idx[labels, model_manager.it % n_seed])
                ...
                with model_manager.on_step(['encoder', 'decoder', 'generator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        z_enc, _, _ = encoder(images, labels)
                        lat_enc = generator(z_enc)
                        images_dec, _, _ = decoder(lat_enc, seed_n=seed_idx[n_labels, model_manager.it % n_seed].tolist())
