        ...
        for batch in t:
            ...
            with model_manager.on_batch():
                ...
                with model_manager.on_step(['dis_encoder', 'discriminator', 'generator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        if one_dec_pass:
                            ...
                            images_redec, _, _ = decoder(lat_gen, out_embs[-1], seed_n=(model_manager.it % (n_seed - 1)) + 1)
                    ...
                    for _ in range(batch_mult):
                        ...
                        if one_dec_pass:
                            ...
                            if config['training']['through_grads']:
                                ...
                                images_redec, _, _ = decoder(lat_gen.detach().clone(), out_embs[-1].detach().clone(), seed_n=(model_manager.it % (n_seed - 1)) + 1)
                ...
                with torch.no_grad():
                    ...
                    if not one_dec_pass:
                        images_regen, _, _ = decoder(lat_gen, out_embs[-1], seed_n=(model_manager.it % (n_seed - 1)) + 1)
