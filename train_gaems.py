            ...
            with model_manager.on_batch():
                ...
                with model_manager.on_step(['dis_encoder', 'discriminator']) as nets_to_train:
                    ...
                    for _ in range(batch_mult):
                        ...
                        lat_top_enc.register_hook(grad_mult_hook(g_factor_enc))
                        ...
                        lat_top_dec.register_hook(grad_mult_hook(g_factor_dec))
                    ...
                    g_factor_enc = np.clip(g_factor_enc - 1e-2 * (labs_dis_enc_sign - 0.5), 1e-3, 1.)
                    g_factor_dec = np.clip(g_factor_dec - 1e-2 * (labs_dis_dec_sign - 0.5), 1e-3, 1.)
