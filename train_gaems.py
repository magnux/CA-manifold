        ...
        for batch in t:
            ...
            with model_manager.on_batch():
                ...
                with model_manager.on_step(['dis_encoder', 'discriminator']) as nets_to_train:
                    ...
                    g_factor_enc = np.clip(g_factor_enc + 1e-3 * (labs_dis_enc_sign - labs_dis_dec_sign - 0.2), 0., 1.)
                    g_factor_dec = np.clip(g_factor_dec + 1e-3 * (labs_dis_dec_sign - labs_dis_enc_sign - 0.0), 0., 1.)
