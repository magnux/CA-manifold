...
class DynaConvS(nn.Module):
    def __init__(self, lat_size, fin, fout, kernel_size=1, stride=1, padding=0, groups=1, dim=2, lat_factor=1):
        ...
        if lat_factor == 0:
            ...
            self.dyna_k = LinearResidualBlockS(self.lat_size, self.k_size + self.b_size, int(self.lat_size * lat_factor))
