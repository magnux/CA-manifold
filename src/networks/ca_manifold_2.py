...
class InjectedEncoder(nn.Module):
    def __init__(self, n_labels, lat_size, image_size, ds_size, channels, n_filter, n_calls, perception_noise, fire_rate,
        ...
        self.out_to_lat = nn.Sequential(
            ...
            *list(chain(*[[ResidualAttentionBlock(sum(self.conv_state_size) // self.n_filter, self.n_filter, self.n_filter // 2, 4),
                           ResidualBlock(self.n_filter, self.n_filter, self.n_filter // 2, 1, 1, 0, nn.Conv1d)] for _ in range(n_blocks)])),
