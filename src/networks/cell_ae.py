...
class InjectedEncoder(nn.Module):
    def __init__(self, n_labels, lat_size, image_size, channels, n_filter, n_calls, perception_noise, fire_rate,
        ...
        self.freq_norm = nn.InstanceNorm2d(self.out_freq.size())
        ...
        self.lat_out = LinearResidualBlock(self.lat_size * 2, lat_size if not z_out else z_dim)
    ...
    def forward(self, x, inj_lat=None, seed_n=0):
        ...
        for c in range(self.n_calls):
            ...
            freq = self.freq_norm(self.out_freq(out)).mean(dim=(2, 3))
