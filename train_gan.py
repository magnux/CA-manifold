    ...
    with model_manager.on_epoch():
        ...
        for batch in t:
            ...
            with model_manager.on_batch():
                ...
                #     # model_manager.log_scalar('stats',  'decoder/%s/norm' % param_name,  param_norm)
                #     # model_manager.log_scalar('stats',  'decoder/%s/max' % param_name,  param_max)
                #     # model_manager.log_scalar('stats',  'decoder/%s/std' % param_name,  param_std)
                #     model_manager.log_scalar('stats',  'decoder/%s/std_norm' % param_name,  param_std / (param_norm + 1e-8))
